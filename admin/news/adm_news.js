            ...
            <div class="row">
              <div class="col-lg-8 col-xl-8">
                <form method="POST" action="`+url+`" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-lg-6" style="padding-left: 0px;"> <label for="InputDate1">Дата</label> <input type="date" name="date" class="form-control" id="InputDate1" placeholder="" required>
                    <div class="valid-feedback">Good!</div>
                    <div class="invalid-feedback">Bad!</div>
                  </div>
                  <div class="form-group"> <label for="InputImg">Изображение</label>
