            ...
            <div class="row">
              <div class="col-lg-8 col-xl-8">
                <form method="POST" action="`+url+`" enctype="multipart/form-data">
                  ...
                  <div class="form-group"> <label for="InputText1">Текст</label> <textarea class="form-control" name="text" id="InputText1" rows="9" placeholder="Введите текст. . ." required>'+localStorage.getItem("text")+'</textarea>
                    <div class="valid-feedback">Good!</div>
                    <div class="invalid-feedback">Bad!</div>
        ...
        <div class="container-fluid">
          <div class="element-team">
            <div class="row">
              <div class="col-lg-8 col-xl-8">
                <form method="POST" action="`+url+`" enctype="multipart/form-data">
                  <div class="form-group"> <label for="InputHeader1">Заголовок</label> <input type="hidden" name="id" value="`+id+`"><input type="text" class="form-control" name="header" id="InputHeader1" aria-describedby="headerHelp" placeholder="Введите заголовок. . ." size=50 required>
                    <div class="valid-feedback">Good!</div>
                    <div class="invalid-feedback">Bad!</div>
                  </div>
                  <div class="form-group col-lg-6" style="padding-left: 0px;"> <label for="InputImg">Изображение</label>
                  ...
                  <div class="form-group"> <label for="InputText1">Текст</label> <textarea class="form-control" name="text" id="InputText1" rows="9" placeholder="Введите текст. . ." required></textarea>
                    <div class="valid-feedback">Good!</div>
                    <div class="invalid-feedback">Bad!</div>
                  </div> <button type="submit" class="btn btn-primary" style="margin-left:0px;"> <div class="btn-ok"></div> </button> <button type="button" id="btn-close-edit" class="btn btn-danger" onclick="clickClose()" )> <div class="btn-del" ></div> </button>            </form>
              </div>
