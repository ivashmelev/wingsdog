                ...
                <div class="col-xl-12">
                    <div class="header__background">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-5 col-sm-9">
                ...
                <div class="col-xl-12">
                    <div class="menu">
                        <nav class="menu-links">
                            ...
                            <div class="menu-item "><a href="#" class="menu-links-item ">Команда</a></div>
                            <div class="menu-item "><a href="#" class="menu-links-item ">Контакты</a></div>
                        </nav>
                        <div class="menu-icon">
                            <label></label>
                            <label></label>
